...
plt.xlabel("Time (s)")
plt.ylabel("MLII")
plt.title("ECG MLII (first 10 min)")
plt.grid()
plt.tight_layout()

plt.savefig(os.path.join(output_dir, "ecg_mlii_1h.png"))
plt.close()
...
plt.xlabel("Time (s)")
plt.ylabel("V5")
plt.title("ECG V5 (first 10 min)")
plt.grid()
plt.tight_layout()

plt.savefig(os.path.join(output_dir, "ecg_v5_1h.png"))
plt.close()