...
#
# Submit with:
#   sbatch slurm/job_benchmark.sh
# =============================================================================

#SBATCH --job-name=ta_job_benchmark.sh
...
#SBATCH --mem=16G
#SBATCH --time=8:00:00
#SBATCH --output=slurm/logs/job_benchmark.sh_%j.out
#SBATCH --error=slurm/logs/job_benchmark.sh_%j.err
