...
# job_metrics_temp.sh
# =============================================================================
# Runs the temp metrics
#
# Submit with:
#   sbatch slurm/job_metrics_temp.sh
# =============================================================================

#SBATCH --job-name=ta_job_metrics_temp.sh
...
#SBATCH --mem=16G
#SBATCH --time=8:00:00
#SBATCH --output=slurm/logs/job_metrics_temp.sh_%j.out
#SBATCH --error=slurm/logs/job_metrics_temp.sh.sh%j.err
...
# ---------------------------------------------------------------------------
banner "temp metrics"
python Metrics_temp_run.py
echo "metrics run complete."

# ---------------------------------------------------------------------------
# 2. plot graphs
# ---------------------------------------------------------------------------

banner "temp metrics plotting"
python Metrics_temp_plot.py
echo "run complete."
