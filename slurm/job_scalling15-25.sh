...
#
# Submit with:
#   sbatch slurm/job_scalling15-25.sh
# =============================================================================

#SBATCH --job-name=ta_job_scalling15-25.sh
...
#SBATCH --mem=16G
#SBATCH --time=8:00:00
#SBATCH --output=slurm/logs/job_scalling15-25.sh_%j.out
#SBATCH --error=slurm/logs/job_scalling15-25.sh_%j.err
