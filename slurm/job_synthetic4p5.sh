...
#
# Submit with:
#   sbatch slurm/job_synthetic4p5.sh
# =============================================================================

#SBATCH --job-name=ta_job_synthetic4p5.sh
...
#SBATCH --mem=16G
#SBATCH --time=8:00:00
#SBATCH --output=slurm/logs/job_synthetic4p5.sh_%j.out
#SBATCH --error=slurm/logs/job_synthetic4p5.sh_%j.err
...
python Metrics_clean_noisy__run4p5.py
