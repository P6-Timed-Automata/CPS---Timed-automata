#!/bin/bash
# =============================================================================
# job_synthetic2p10.sh
# =============================================================================
# Runs the SYNTHETIC CLEAN_noisy plots and run

#
# Submit with:
#   sbatch slurm/job_synthetic2p10.sh
# =============================================================================

#SBATCH --job-name=ta_job_synthetic2p10.sh
...
#SBATCH --mem=16G
#SBATCH --time=8:00:00
#SBATCH --output=slurm/logs/job_synthetic2p10.sh_%j.out
#SBATCH --error=slurm/logs/job_synthetic2p10.sh_%j.err
...
python Metrics_clean_noisy__run2p10.py
