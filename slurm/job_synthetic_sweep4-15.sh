#!/bin/bash
# =============================================================================
# job_synthetic_sweep4-15.sh
# =============================================================================
# Runs the SYNTHETIC sweep
#
# Submit with:
#   sbatch slurm/job_synthetic_sweep4-15.sh
# =============================================================================

#SBATCH --job-name=job_synthetic_sweep4-15.sh
...
#SBATCH --mem=16G
#SBATCH --time=8:00:00
#SBATCH --output=slurm/logs/job_synthetic_sweep4-15.sh_%j.out
#SBATCH --error=slurm/logs/job_synthetic_sweep4-15.sh_%j.err
...
python Metrics_synthetic_noisy-sweep_run4-15.py
