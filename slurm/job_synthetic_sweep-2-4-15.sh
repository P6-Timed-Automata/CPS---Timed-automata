#!/bin/bash
# =============================================================================
# job_synthetic_sweep-2-4-5.sh
# =============================================================================
# Runs the SYNTHETIC sweep
#
# Submit with:
#   sbatch slurm/job_synthetic_sweep-2-4-5.sh
# =============================================================================

#SBATCH --job-name=ta_job_synthetic_sweep-2-4-5.sh
...
#SBATCH --mem=16G
#SBATCH --time=8:00:00
#SBATCH --output=slurm/logs/job_synthetic_sweep-2-4-5.sh_%j.out
#SBATCH --error=slurm/logs/job_synthetic_sweep-2-4-5.sh%j.err
...
# ---------------------------------------------------------------------------
banner "synthetic noise sweep"
python Metrics_synthetic_sweep_2_run-4-15.py
...
banner "synthetic noise sweep"
python Metrics_synthetic_sweep_2_plot.py
echo "sweep run complete."
