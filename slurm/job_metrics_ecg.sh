...
#
# Submit with:
#   sbatch slurm/job_metrics_ecg.sh
# =============================================================================

#SBATCH --job-name=ta_job_metrics_ecg.sh
...
#SBATCH --mem=16G
#SBATCH --time=8:00:00
#SBATCH --output=slurm/logs/job_metrics_ecg.sh_%j.out
#SBATCH --error=slurm/logs/job_metrics_ecg.sh_%j.err
